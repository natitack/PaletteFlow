/**
 * Color theme definitions using OKLCH color space values
 */
...
/**
 * Theme colors with OKLCH values
 */
...
/**
 * Helper function to access a specific color shade
 * @param colorName The name of the color family
 * @param shade The shade of the color
 * @returns The OKLCH color value as a string
 */
export function getColor(
  colorName: keyof Omit<ThemeColors, 'black' | 'white'>, 
  shade: ColorShade
): string {
...
/**
 * Helper function to get a base color
 * @param colorName Either 'black' or 'white'
 * @returns The hex color value
 */
export function getBaseColor(colorName: 'black' | 'white'): string {
